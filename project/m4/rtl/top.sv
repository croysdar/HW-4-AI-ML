...
// at WEIGHT_DEPTH=64 words × 256 bits.
//
// Weight memory
// -------------
// WEIGHT_DEPTH=64 uses a 64×256-bit register file (~16K FFs), well within
// Yosys/ABC capacity. The production architecture requires WEIGHT_DEPTH=1512
// (conv2/conv3/conv4 weight tiles), which maps to 8-wide × 3-deep Sky130
// OpenRAM macros. SRAM macro integration was attempted but the available
...
// arrangement when tiled 8-wide for 256-bit word width. This is documented
// in synthesis_notes.md (Section: SRAM macro routing failure). The compute
// logic, interfaces, and tile FSM are identical to the production design.
//
// Port Descriptions
// -----------------
