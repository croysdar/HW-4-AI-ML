// =============================================================================
// File   : project/m4/sram_8macro_experiment/sim/tb_timing_8macro.sv
// Module : tb_timing_8macro
//
// Cycle-accurate throughput benchmark for the 8-SRAM 256-bit bnn_top.
...
//
// Throughput model per tile:
//   cycles = n_beats + pipeline_drain
//   pipeline_drain = 4  (1 SRAM read + 3 compute_core stages)
//   Compare to 1-macro: cycles = n_beats × 8 + 7 (8 serial chunks + drain)
// =============================================================================
...
module tb_timing_8macro;
    ...
    // Load all 256 logical words with random data.
    // Each word: 8 consecutive w_en cycles at the same w_addr.
    // w_bank_sel inside DUT routes each 32-bit chunk to banks 0..7.
    ...
    initial begin
        ...
        begin
            ...
            real    energy_mj;
            // post-PNR OpenSTA @ nom_tt_025C_1v80 (includes 8× SRAM macro power)
            localparam real POWER_MW = 17.78;
